    ...
    <div className="container mx-auto mt-12 p-6 bg-blue-100">
      <div className="relative border-8 border-double border-gray-300">
        ...
        <div className="relative p-12 bg-white shadow-lg">
          ...
          <div className="text-center mb-8">
            <span className="text-2xl block mb-4">Name: <span id="name" className="font-bold">TBD</span></span>
            <span className="block text-xl italic">has earned</span>
            <span className="text-2xl block mt-2">Grade: <span id="grade" className="font-bold">TBD</span></span>
          </div>
          <div className="text-center mb-8">
            <span className="block text-xl italic">while completing the training course entitled</span>
            <span className="text-2xl block mt-2 underline">Course: <span id="course" className="font-bold">TBD</span></span>
          </div>
          <div className="flex justify-between mb-8">
            <div className="text-xl">
              <span>Certificate ID: <span id="ID" className="font-bold">TBD</span></span>
            </div>
            <div className="text-xl text-right">
              <span>Date of Completion: <span id="date" className="font-bold">TBD</span></span>
              <br />
